...
-- @param o table Table of UI properties (win_id, deck_buf_id, note_buf_id, notes, current_filter).
	...
	setmetatable(o, {
		...
		__tostring = function(tbl)
			return string.format(
				"UI(win_id=%s, deck_buf_id=%s, note_buf_id=%s, notes=%d, decks=%d, current_filter=%s)",
				tostring(tbl.win_id),
