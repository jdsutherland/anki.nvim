...
describe("anki.config", function()
	...
	describe("defaults", function()
		...
		it("has deck mapping keys", function()
			...
			assert.is_not_nil(deck.edit_templates)
			assert.is_not_nil(deck.create_model)
		end)
		...
		it("has template mapping keys", function()
			local template = config.defaults.mappings.template
			assert.is_not_nil(template.save_template)
			assert.is_not_nil(template.pull_template)
			assert.is_not_nil(template.switch_card)
			assert.is_not_nil(template.close_template)
			assert.is_not_nil(template.show_help)
		end)
		...
		it("has media_browser defaults with all keys", function()
			...
			assert.are.equal(2, mb.pane_gap)
			assert.are.same("single", mb.border)
